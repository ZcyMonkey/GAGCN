...
parser.add_argument('--data_dir',type=str,default='/data/zhongchongyang/Gating-GCN/datasets/',help='path to the unziped dataset directories(H36m/AMASS/3DPW)')
...
parser.add_argument('--milestones',type=list,default=[20,40,60,80,100,120,140,160,180],help= 'the epochs after which the learning rate is adjusted by gamma')
...
parser.add_argument('--model_path',type=str,default='./checkpoints/2021.11.25_used',help= 'directory with the models checkpoints ')
...
parser.add_argument('--actions_to_consider',default='walking',help= 'Actions to visualize.Choose either all or a list of actions')
parser.add_argument('--n_viz',type=int,default='8',help= 'Numbers of sequences to visaluze for each action')
