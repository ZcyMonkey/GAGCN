  ...
  for action in actions:
    ...
    for cnt,batch in enumerate(test_loader):
      with torch.no_grad():
        ...
        #print("Euler error: frame02  :{0}        frame04:  {1}        frame8:  {2}        frame10:  {3}        frame14:  {4}      frame18:  {5}   frame22:  {6}  frame25:  {7}".format(loss[1],loss[3],loss[7],loss[9],loss[13],loss[17],loss[21],loss[24]))
        #print("MPIPE error: frame02  :{0}        frame04:  {1}        frame8:  {2}        frame10:  {3}        frame14:  {4}      frame18:  {5}   frame22:  {6}  frame25:  {7}".format(mpjpe_loss[1],mpjpe_loss[3],mpjpe_loss[7],mpjpe_loss[9],mpjpe_loss[13],mpjpe_loss[17],mpjpe_loss[21],mpjpe_loss[24]))
        #print("Euler error: frame01  :{0}        frame02:  {1}".format(loss[0],loss[1]));
        #print("MPIPE error: frame02  :{0}        frame04:  {1}".format(mpjpe_loss[0],mpjpe_loss[1]));
        running_loss+=loss*batch_dim
