...
class ConvTemporalGraphical(nn.Module):
    ...
    def forward(self, x):
        ...
        Gating_weight_t = nn.functional.softmax(t, dim=1)
        # print('t')
        # print(Gating_weight_t)
        # print('s')
        # print(Gating_weight_s)
        batch_size = x.size()[0]
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.st_gcnns.append(ST_GCNN_layer(64,64,[1,1],1,input_time_frame,
                                           joints_to_consider,st_gcnn_dropout))
        self.st_gcnns.append(ST_GCNN_layer(64,64,[1,1],1,input_time_frame,
                                   joints_to_consider,st_gcnn_dropout))
